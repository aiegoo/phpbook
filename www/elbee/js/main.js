$(function () {$('#gallery').each(function () {var $container = $(this),
        ...
        function initGallery (data) {
            ...
            $filter.on('change', 'input[type="radio"]', filterItems);$container.on('mouseenter mouseleave', '.gallery-item a', hoverDirection);
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        }
