...
<meta property="og:title" content="서울여성공예센터 더아리움" />
	...
	<meta property="og:description" content="근본이 다른 디자인입니다." />
	<meta property="og:url" content="https://tonyleekorea.com/" />
	<meta property="og:image" content="http://app-storage-007.cafe24.com/bannermanage2/eozz21/2018/11/21/fa71b6385aff451bb1dbefbc56b6c948.jpg" />
...
$(".gnb-goto-category").click(function(e) {
        ...
        $('#mainlisttrigger').click(function(){
            ...
            $.ajax({
               type: "GET"
               ,dataType: "xml"
               ,url:  "/20181127/xml/introduce/brand.xml"
...
<div id="wrapper">
       <div id="gnb">
            <div class="gnb">
                <h1 class="gnb-logo">            
                    <a href="/20181127/" title="홈 바로가기" class="link_area" >
...
<em class="font12">©tonyleekorea</em>
</div>
